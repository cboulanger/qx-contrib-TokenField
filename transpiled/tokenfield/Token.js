(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define('tokenfield.Token', {
    ...
    */
    members: {
      ...
      */
      ...
      _createChildControlImpl: function _createChildControlImpl(id) {
        ...
        switch (id) {
          ...
          case 'list':
            ...
            control = tokenfield.Token.prototype._createChildControlImpl.base.call(this, id);
       ...
       * @return {qx.ui.core.Widget}
       */
      __createItem: function __createItem() {
       ...
       */
      __bindItem: function __bindItem(model, item) {
        var delegate = this.getDelegate();
...
//# sourceMappingURL=Token.js.map?dt=1554385338027
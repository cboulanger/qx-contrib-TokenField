(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.dao.Node", {
    ...
    construct: function construct(meta) {
      ...
      this._meta = {};
      this._jsdoc = {};
      if (meta !== undefined) this._initMeta(meta);
    },
    ...
    members: {
      ...
      getDescription: function getDescription() {
        ...
        if (arr && arr.length) return arr[arr.length - 1].body;
        return "";
      },
...
//# sourceMappingURL=Node.js.map?dt=1554385338749
(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.dao.Method", {
    ...
    construct: function construct(meta, clazz, name) {
      ...
      if (arr && arr.length) this._return = new qxl.apiviewer.dao.Param(arr[0], this);
...
//# sourceMappingURL=Method.js.map?dt=1554385338770
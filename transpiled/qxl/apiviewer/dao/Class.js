(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.dao.Class", {
    ...
    members: {
      ...
      _initMeta: function _initMeta(meta) {
        ...
        if (meta.members) {
          for (var _name in meta.members) {
            ...
            if (_data.type == "function") {
              ...
              if (_data.mixin) this._mixinMembers.push(obj);else this._members.push(obj);
            }
          }
        }
        ...
        if (meta.properties) {
          for (var _name2 in meta.properties) {
            ...
            if (_data2.mixin) this._mixinProperties.push(_obj);else this._properties.push(_obj);
          }
        }
        ...
        if (meta.events) {
          for (var _name3 in meta.events) {
            ...
            if (_data3.mixin) this._mixinEvents.push(_obj2);else this._events.push(_obj2);
          }
        }
        ...
        function findClasses(tmp) {
          return qxl.apiviewer.dao.Class.findClasses(tmp).forEach(function (item) {
      ...
      getChildClasses: function getChildClasses() {
        if (!this._childClassesPromise) {
          if (this._meta.type == "class") this._childClassesPromise = qxl.apiviewer.dao.Class.findClasses(this._meta.descendants);else this._childClassesPromise = qx.Promise.resolve([]);
        }
      ...
      getIncluder: function getIncluder() {
        if (!this._includersPromise) {
          if (this._meta.type == "mixin") this._includersPromise = qxl.apiviewer.dao.Class.findClasses(this._meta.descendants);else this._includersPromise = qx.Promise.resolve([]);
        }
      ...
      getImplementations: function getImplementations() {
        if (!this._implementationsPromise) {
          if (this._meta.type == "interface") this._implementationsPromise = qxl.apiviewer.dao.Class.findClasses(this._meta.descendants);else this._implementationsPromise = qx.Promise.resolve([]);
        }
    ...
    statics: {
      ...
      getClassByName: function getClassByName(className, create) {
        ...
        if (nativeClass !== undefined) return nativeClass;
...
//# sourceMappingURL=Class.js.map?dt=1554385338643
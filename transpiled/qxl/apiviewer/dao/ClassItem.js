(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.dao.ClassItem", {
        ...
        if (arr) {
          arr.map(function (item) {
            ...
            if (result.type) {
              ...
              if (dims) result.dimensions = dims.length;
            }
            return result;
          });
        }
...
//# sourceMappingURL=ClassItem.js.map?dt=1554385338950
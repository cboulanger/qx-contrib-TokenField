(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.ui.panels.AbstractMethodPanel", {
    ...
    members: {
      ...
      getPanelItemObjects: function getPanelItemObjects(daoClass, showInherited) {
        ...
        if (showInherited) arr = arr.concat(daoClass.getMixinMethods());
        return arr;
      },
...
//# sourceMappingURL=AbstractMethodPanel.js.map?dt=1554385339328
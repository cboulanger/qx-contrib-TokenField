(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      getPanelItemObjects: function getPanelItemObjects(daoClass, showInherited) {
        ...
        if (showInherited) arr = arr.concat(daoClass.getMixinProperties());
        return arr;
      },
...
//# sourceMappingURL=PropertyPanel.js.map?dt=1554385339264
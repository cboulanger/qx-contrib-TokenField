(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.ui.panels.ClassPanel", {
    ...
    members: {
      ...
      canDisplayItem: function canDisplayItem(dao) {
        if (!(dao instanceof qxl.apiviewer.dao.Class)) return false;
...
//# sourceMappingURL=ClassPanel.js.map?dt=1554385339032
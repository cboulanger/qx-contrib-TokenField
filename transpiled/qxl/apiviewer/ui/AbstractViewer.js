(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.ui.AbstractViewer", {
    type: "abstract",
    ...
    members: {
      ...
      _updatePanels: function _updatePanels() {
        ...
        if (!this.getDocNode()) return qx.Promise.resolve();
      ...
      _applyDocNode: function _applyDocNode(classNode) {
        ...
        return this._getDescriptionHtml(classNode).then(function (html) {
          ...
          qxl.apiviewer.ui.AbstractViewer.highlightCode(_this4._classDescElem);
...
//# sourceMappingURL=AbstractViewer.js.map?dt=1554385339018
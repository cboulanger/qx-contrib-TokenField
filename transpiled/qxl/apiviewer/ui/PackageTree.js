(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qxl.apiviewer.ui.PackageTree", {
    ...
    members: {
      ...
      selectTreeNodeByClassName: function selectTreeNodeByClassName(className) {
        ...
        var next = function next() {
          ...
          if (!treeNode) return qx.Promise.resolve(false);
          treeNode.setOpen(true);
          return treeNode.loading.then(function () {
            nameIndex++;
            if (nameIndex < nameParts.length) return next();
            return treeNode;
          });
        };
      ...
      __fillPackageNode: function __fillPackageNode(treeNode, docNode, depth) {
        ...
        packagesDoc.forEach(function (packageDoc) {
          ...
          packageTreeNode.addListener("changeOpen", _this2.__getPackageNodeOpener(packageTreeNode, packageDoc, depth + 1), _this2);
...
//# sourceMappingURL=PackageTree.js.map?dt=1554385338345
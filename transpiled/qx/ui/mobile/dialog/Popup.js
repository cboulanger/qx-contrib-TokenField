(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qx.ui.mobile.dialog.Popup", {
    ...
    members: {
      ...
      show: function show() {
        if (!this.__isShown) {
          ...
          // objects height.
          qx.ui.mobile.dialog.Popup.prototype.show.base.call(this);
...
//# sourceMappingURL=Popup.js.map?dt=1554385331340
(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Bootstrap.define("qx.ui.website.Slider", {
    ...
    members: {
      ...
      _getKnobContent: function _getKnobContent() {
        return qxWeb.template.render(this.getTemplate("knobContent"), { value: this.getValue() });
      },
...
//# sourceMappingURL=Slider.js.map?dt=1554385336261
    ...
    statics: {
      ...
      addNativeListener: function addNativeListener(target, type, listener, useCapture, passive) {
        if (target.addEventListener) {
          if (passive === undefined || !qx.core.Environment.get("event.passive")) target.addEventListener(type, listener, !!useCapture);else target.addEventListener(type, listener, { capture: !!useCapture, passive: !!passive });
...
//# sourceMappingURL=Event.js.map?dt=1554385313376
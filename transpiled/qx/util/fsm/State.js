...
(function () {
  ...
  qx.Bootstrap.executePendingDefers($$dbClassInfo);qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      if ((typeof stateInfo === "undefined" ? "undefined" : _typeof(stateInfo)) != "object") {
    ...
    statics: {
      ...
      _commonTransformAutoActions: function _commonTransformAutoActions(actionType, value, context) {
        ...
        if ((typeof value === "undefined" ? "undefined" : _typeof(value)) != "object") {
          throw new Error("Invalid " + actionType + " value: " + (typeof value === "undefined" ? "undefined" : _typeof(value)));
        }
        ...
        for (var f in value) {
          ...
          if (!functionRequest instanceof Array) {
            throw new Error("Invalid function request type: expected array, found " + (typeof functionRequest === "undefined" ? "undefined" : _typeof(functionRequest)));
          }
          ...
          for (var i = 0; i < functionRequest.length; i++) {
            ...
            //   "groups"  : [ "group1", "group2" ],
            // }
            if ((typeof objectAndGroupList === "undefined" ? "undefined" : _typeof(objectAndGroupList)) != "object") {
            ...
            if (!params) {
              ...
              if (!params instanceof Array) {
                throw new Error("Invalid function parameters: expected array, found " + (typeof params === "undefined" ? "undefined" : _typeof(params)));
              }
            }
            ...
            if (!a) {
              ...
              throw new Error("Invalid 'objects' list: expected array, got " + (typeof a === "undefined" ? "undefined" : _typeof(a)));
            }
            ...
            if (g) {
              ...
              if (!g instanceof Array) {
                throw new Error("Invalid 'groups' list: expected array, got " + (typeof g === "undefined" ? "undefined" : _typeof(g)));
              }
    ...
    members: {
      ...
      __transformOnentry: function __transformOnentry(value) {
        ...
        switch (typeof value === "undefined" ? "undefined" : _typeof(value)) {
          ...
          default:
            throw new Error("Invalid onentry type: " + (typeof value === "undefined" ? "undefined" : _typeof(value)));
        }
      },
      ...
      __transformOnexit: function __transformOnexit(value) {
        ...
        switch (typeof value === "undefined" ? "undefined" : _typeof(value)) {
          ...
          default:
            throw new Error("Invalid onexit type: " + (typeof value === "undefined" ? "undefined" : _typeof(value)));
        }
      },
...
//# sourceMappingURL=State.js.map?dt=1554385337761